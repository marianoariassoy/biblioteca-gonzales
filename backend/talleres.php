...
if (isset($_POST['form'])) {
  ...
  if ($action == 'Agregar') {
    ...
    $sql = 'INSERT INTO ' . $table . ' 
		(`type`, `title`, `subtitle`, `text`, `image`, `url`, `top` ) 
		VALUES 
    ...
    $sql = 'UPDATE ' . $table . ' 
    SET 
    `title` = "' . $title  . '", `subtitle` = "' . $subtitle . '", `text` = "' . $text . '", `url` = "' . $url . '", `top` = "' . $top . '"';
        ...
        <form method="POST" name="form" enctype="multipart/form-data">
          <div class="row mb-5">
            ...
            <div class="col col-12 mb-3">
              ...
              <textarea name="text" cols="30" rows="6" id="wysihtml5-textarea" class="form-control bg-transparent text-white mb-2"><?php if (isset($results['text'])) echo ($results['text']) ?></textarea>
            </div>
            ...
            <div class="col col-12 col-md-6 mb-3">
              ...
              <input type="number" name="url" class="form-control bg-transparent text-white mb-2" value="<?php if (isset($results['url'])) echo ($results['url']) ?>" />
