...
if (isset($_GET['add'])) {
  ...
  $action = 'Agregar';
  $title_sec = "Agregar Testimonio";
} else if (isset($_GET['edit'])) {

  $action = 'Modificar';
  $title_sec = "Modificar Testimonio";
  $id_select = $_GET['i'];
  ...
  $title_sec = "Listado de Testimonios";
      ...
      <section class="p-3 p-lg-5 p-md-4 text-white">
        ...
        <form method="POST" name="form" enctype="multipart/form-data">
          <div class="row mb-5">
            ...
            <div class="col col-12 col-md-6 mb-3  pe-md-3 ">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td valign="middle">
                    <a href="images-simple.php?id_sec=<?php echo $id; ?>">Carrete (<?php echo $total_images; ?>)</a>
                  </td>
                  <td valign="middle">
                    <?php echo $top; ?>
                  </td>
