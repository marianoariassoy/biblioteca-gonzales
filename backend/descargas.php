...
if (isset($_GET['add'])) {
  ...
  $action = 'Agregar';
  $title_sec = "Agregar Sobre Archivos";
} else if (isset($_GET['edit'])) {

  $action = 'Modificar';
  $title_sec = "Modificar Sobre Archivos";
  $id_select = $_GET['i'];
  ...
  $title_sec = "Listado de Sobre Archivos";
        ...
        <form method="POST" name="form" enctype="multipart/form-data">
          <div class="row mb-5">
            ...
            <div class="col col-12 col-md-6 pe-md-3 mb-3">
              ...
              <?php if (isset($results['file'])) if ($results['file'])  echo '<a href="./images/' . $results['file'] . '" target="_blank" class="opacity">Descargar Archivo</a>'; ?>
            </div>
