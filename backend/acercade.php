...
if (isset($_GET['add'])) {
  ...
  $action = 'Agregar';
  $title_sec = "Agregar Imagen";
} else if (isset($_GET['edit'])) {

  $action = 'Modificar';
  $title_sec = "Modificar Imagen";
  $id_select = $_GET['i'];
  ...
  $title_sec = "Biografía en 10 pasos";
        ...
        <form method="POST" name="form" enctype="multipart/form-data">
          <div class="row mb-5">
            ...
            <div class="col col-12 mb-3">
              ...
              <textarea name="text" cols="30" rows="20" id="wysihtml5-textarea" class="form-control bg-transparent text-white mb-2"><?php if (isset($results['text'])) echo ($results['text']) ?></textarea>
            </div>
        ...
        ?>
          <table class="table table-dark table-hover">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td valign="middle" class="text-primary"><img src="./images/<?php echo $image; ?>" class="img-circle-large mb-3" /></td>
