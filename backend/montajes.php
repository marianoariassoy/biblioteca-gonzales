...
if (isset($_POST['form'])) {
  ...
  if ($action == 'Agregar') {
    ...
    $sql = 'INSERT INTO ' . $table . ' 
		(`type`, `title`, `text`, `text2`, `top`, `image` ) 
		VALUES 
		("' . $sec  . '", "' . $title . '", "' . $text . '", "' . $text2 . '",  "' . $top . '",  "' . $image . '" )';
    $statement = $pdo->prepare($sql);
    $statement->execute();
    header("Location:$file_main");
  } else {
    $sql = 'UPDATE ' . $table . ' 
    SET `title` = "' . $title  . '", `text` = "' . $text . '", `text2` = "' . $text2 . '", `top` = "' . $top . '"';
...
if (isset($_GET['add'])) {
  ...
  $action = 'Agregar';
  $title_sec = "Agregar Montaje";
} else if (isset($_GET['edit'])) {

  $action = 'Modificar';
  $title_sec = "Modificar Montaje";
  $id_select = $_GET['i'];
  ...
  $title_sec = "Listado de Montajes y secciones";
...
<body class="bg-dark">
        ...
        <form method="POST" name="form" enctype="multipart/form-data">
          <div class="row mb-5">
            ...
            <div class="col col-12 mb-3">
              ...
              <textarea name="text2" cols="30" rows="3" class="form-control bg-transparent text-white mb-2"><?php if (isset($results['text2'])) echo ($results['text2']) ?></textarea>
            </div>
            <div class="col col-12 mb-3">
              ...
              <textarea name="text" cols="30" id="wysihtml5-textarea" rows="12" class="form-control bg-transparent text-white mb-2"><?php if (isset($results['text'])) echo ($results['text']) ?></textarea>
            </div>
            <div class="col col-12 mb-3">
      ...
      <section class="p-3 p-lg-5 p-md-4 text-white">
        <div class="row mb-4">
          <div class="col-10 col-md-10 mb-2">
            <h2><strong><?php echo $title_sec ?></strong> (<?php echo $total + 5 ?>)</h2>

            <!-- <a href="mapas">Mapas</a> - <a href="fantasmal">Fantasmal</a> - <a href="recomendaciones">Recomendaciones</a> - <a href="textitos">Textitos</a> - <a href="testimonios">Testimonios</a> -->
          </div>
        ...
        ?>
          <table class="table table-dark table-hover">
            ...
            <tbody>
              ...
              ?>
              <tr>
                <td valign="middle" class="text-primary">Mapas</td>
                <td></td>
                <td></td>
                <td align="right">
                  <a href="mapas" class="circle bg-transparent"><i class="bi bi-file-earmark-text"></i></a>
                </td>
              </tr>
              <tr>
                <td valign="middle" class="text-primary">Fantasmal</td>
                <td></td>
                <td></td>
                <td align="right"> <a href="fantasmal" class="circle bg-transparent"><i class="bi bi-file-earmark-text"></i></a>
                </td>
              </tr>
              <tr>
                <td valign="middle" class="text-primary">Recomendaciones</td>
                <td></td>
                <td></td>
                <td align="right"> <a href="recomendaciones" class="circle bg-transparent"><i class="bi bi-file-earmark-text"></i></a>
                </td>
              </tr>
              <tr>
                <td valign="middle" class="text-primary">Textitos</td>
                <td></td>
                <td></td>
                <td align="right"> <a href="textitos" class="circle bg-transparent"><i class="bi bi-file-earmark-text"></i></a>
                </td>
              </tr>
              <tr>
                <td valign="middle" class="text-primary">Testimonios</td>
                <td></td>
                <td></td>
                <td align="right"> <a href="testimonios" class="circle bg-transparent"><i class="bi bi-file-earmark-text"></i></a>
                </td>
              </tr>
  ...
  <!-- <script>
    var wysihtml5ParserRules = {
      classes: {
        "wysiwyg-font-size-large": 2,
        "wysiwyg-font-size-small": 1
      },
      attributes: {
        "wysiwyg-font-size": "wysiwyg-font-size-large wysiwyg-font-size-small"
      },
      tags: {
        "ul": 1,
        "li": 1
