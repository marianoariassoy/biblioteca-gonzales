...
const Box1 = ({ title, color, image, url }: Props) => {
  return (
    <article className='rounded-2xl aspect-[7/4] text-white relative overflow-hidden'>
      <span className='absolute top-6 left-6 font-secondary font-bold z-20'>{title}</span>
      <Link to={`${url}`}>
        <a
